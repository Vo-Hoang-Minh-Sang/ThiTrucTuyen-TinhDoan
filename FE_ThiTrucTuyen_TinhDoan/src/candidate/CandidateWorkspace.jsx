...
export function ExamRunner({ initial, candidate, unitName, token, userId, onExit }) {
  ...
  // Moi trang hien thi toi da muoi cau de thi sinh khong phai tai hoac cuon toan bo de cung luc.

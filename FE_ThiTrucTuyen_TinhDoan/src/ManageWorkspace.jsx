...
const blankQuestion = { competitionId: '', content: '', optionA: '', optionB: '', optionC: '', optionD: '', correctAnswer: 'A', difficulty: 'medium' };
...
function ExamBuilder({ token, competitions }) {
  const [form, setForm] = useState({ competitionId: '', count: 10, difficulty: '', quantity: 1 });
